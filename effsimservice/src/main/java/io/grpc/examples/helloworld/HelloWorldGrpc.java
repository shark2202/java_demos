...
public final class HelloWorldGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.examples.helloworld.HelloWorldProto.HelloRequest,
      io.grpc.examples.helloworld.HelloWorldProto.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = io.grpc.examples.helloworld.HelloWorldProto.HelloRequest.class,
      responseType = io.grpc.examples.helloworld.HelloWorldProto.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.examples.helloworld.HelloWorldProto.HelloRequest,
      io.grpc.examples.helloworld.HelloWorldProto.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<io.grpc.examples.helloworld.HelloWorldProto.HelloRequest, io.grpc.examples.helloworld.HelloWorldProto.HelloReply> getSayHelloMethod;
      ...
      synchronized (HelloWorldGrpc.class) {
        if ((getSayHelloMethod = HelloWorldGrpc.getSayHelloMethod) == null) {
          HelloWorldGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<io.grpc.examples.helloworld.HelloWorldProto.HelloRequest, io.grpc.examples.helloworld.HelloWorldProto.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.helloworld.HelloWorldProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.helloworld.HelloWorldProto.HelloReply.getDefaultInstance()))
  ...
  public static abstract class HelloWorldImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(io.grpc.examples.helloworld.HelloWorldProto.HelloRequest request,
        io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.HelloWorldProto.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.grpc.examples.helloworld.HelloWorldProto.HelloRequest,
                io.grpc.examples.helloworld.HelloWorldProto.HelloReply>(
  ...
  public static final class HelloWorldBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloWorldBlockingStub> {
    ...
    /**
     */
    public io.grpc.examples.helloworld.HelloWorldProto.HelloReply sayHello(io.grpc.examples.helloworld.HelloWorldProto.HelloRequest request) {
  ...
  public static final class HelloWorldFutureStub extends io.grpc.stub.AbstractFutureStub<HelloWorldFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.helloworld.HelloWorldProto.HelloReply> sayHello(
        io.grpc.examples.helloworld.HelloWorldProto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((io.grpc.examples.helloworld.HelloWorldProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.HelloWorldProto.HelloReply>) responseObserver);
          break;
        default:
